...
| Seed + direction + brief + two finished ads, whose overlaid text has fewer flaws (rendering, grounding, language)? Ignore design and the picture | `handshake-ads-text-flaws` | `project-hedgehog/handshake-ads-text-flaws/SKILL.md` |
...
| Prompt + two images, one preference + markers clicked onto the evidence (Point + write) | `handshake-t2i-point-write` | `project-hedgehog/handshake-t2i-point-write/SKILL.md` |
