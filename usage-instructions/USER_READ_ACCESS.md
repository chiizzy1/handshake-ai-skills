...
```powershell
git clone https://github.com/chiizzy1/handshake-ai-skills.git "C:\Users\$env:USERNAME\Desktop\projects\train-ai\handshake-ai-skills"
```

3. Open the repo folder:

```powershell
cd "C:\Users\$env:USERNAME\Desktop\projects\train-ai\handshake-ai-skills"
```
...
git -C "C:\Users\$env:USERNAME\Desktop\projects\train-ai\handshake-ai-skills" restore .
git -C "C:\Users\$env:USERNAME\Desktop\projects\train-ai\handshake-ai-skills" pull --ff-only
```
